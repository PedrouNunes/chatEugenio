...
instead of running the command; a single word matching the value works):
  ...
  TECLA TECLA_NORMAL F1 F1 F1 1 -1 -1
  TECLA TECLA_NORMAL F2 F2 F2 1 -1 -1
  TECLA TECLA_NORMAL F3 F3 F3 1 -1 -1
  TECLA TECLA_NORMAL F4 F4 F4 1 -1 -1
  TECLA TECLA_NORMAL F5 F5 F5 1 -1 -1
  TECLA TECLA_NORMAL F6 F6 F6 1 -1 -1
  TECLA TECLA_NORMAL F7 F7 F7 1 -1 -1
  TECLA TECLA_NORMAL F8 F8 F8 1 -1 -1
  TECLA TECLA_NORMAL F9 F9 F9 1 -1 -1
