...
class AgentState(TypedDict):
    # Caminho do arquivo de imagem fornecido ao agente
...
def build_llm() -> ChatOpenAI:
    ...
    if not openai_api_key:
        raise ValueError(
            ...
            "Para esta aula, a forma mais fiel ao curso é usar OpenAI."
        )
...
# Modelo com visão para extração de texto da imagem
